 ...
 */
public abstract class AbstractShortestPathAlgorithmB {

    protected final HashMap<NodeData, Color> colors;
    protected final HashMap<NodeData, Double> distances;
    protected final HashMap<NodeData, Boolean> beTheres; 
    protected final Node sourceNode;
    protected final Node beThereNode;
    protected double maxDistance = 0;

    public AbstractShortestPathAlgorithmB(Node sourceNode, Node beThereNode) {
        this.sourceNode = sourceNode;
        this.beThereNode = beThereNode;
        colors = new HashMap<NodeData, Color>();
        distances = new HashMap<NodeData, Double>();
        beTheres = new HashMap<NodeData, Boolean>();
    }
    ...
    protected boolean relax(Edge edge) {
        ...
        if (sourceWeight < distTarget) {
            ...
            //beTheres.put(target.getNodeData(), 1d);
            //System.out.println("bethere " + beTheres);
    ...
    public HashMap<NodeData, Boolean> getIsTheres() {
        return beTheres;
    }
